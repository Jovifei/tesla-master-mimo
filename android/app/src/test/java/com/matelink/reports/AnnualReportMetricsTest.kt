...
class AnnualReportMetricsTest {
    ...
    @Test
    fun standbyRequiresBatteryDropAndNoDrive() {
        ...
        assertEquals(7.5, annualStandbyKwh(2026, listOf(previous, next), emptyList())!!, 0.0)
        val drive = DriveData(9, startDate = "2026-01-01T12:00:00Z", endDate = "2026-01-01T13:00:00Z")
        assertNull(annualStandbyKwh(2026, listOf(previous, next), listOf(drive)))
    }
}
